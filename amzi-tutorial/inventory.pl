...
customer(customer1,city1,aaa).
customer(customer4,city2,aaa).

customer(customer2,address('718 Tulip St',city1,iowa,50010),aaa).
customer(customer3,address(unknown,unknown,city3,tennessee,unknown),aaa).
...
% good_customer(X) :- customer(X, city1, _).
